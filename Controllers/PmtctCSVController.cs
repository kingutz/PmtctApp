...
namespace Pmtct.Controllers
{
    ...
    public class PmtctCSVController : Controller
    {
...

        {
            ...
            "UmepataHapaHuduma206,UmriMimba301,MwakaVVU302,MdaVVU303,DawaVVU304a,LiniDawaVVU304b,CTC304c,UserId");
                foreach (var item in pmtctDatas)
                {
                    ...
                    $"{item.DawaVVU304a},{item.LiniDawaVVU304b},{item.CTC304c},{item.UserId}");
                }
